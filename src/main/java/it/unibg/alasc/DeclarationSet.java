...
public class DeclarationSet {
	 ...
	 * @param level La profondit� del blocco in cui avviene la dichiarazione.
	 * @return <tt>true</tt> se la variabile non era gi� stata dichiarata nel 
	 ...
	 * 
	 * In questa implementazione si � scelto di risalire lungo i blocchi alla ricerca
	 * della prima dichiarazione. In caso questa non sia trovata viene ritornato null.
	 * 
	 * La risolvibilit� di una variabile pu� essere controllata con il metodo <tt>isReachable</tt>.
	 * 
	 * @param varName Il nome della variabile.
	 * @param level La profondit� del blocco.
	 ...
	 * nel blocco di profondit� <tt>level</tt>.
	 * 
	 ...
	 * @param level La profondit� del blocco.
	 * @return <tt>true</tt> se non ci sono gi� dichiarazioni della variabile nel blocco,
	 ...
	 * @param variableName Il nome della variabile.
	 * @param level La profondit� del blocco.
	 * @return <tt>true se nello scope visibile dal blocco a profondit� <tt>level</tt> la variabile
