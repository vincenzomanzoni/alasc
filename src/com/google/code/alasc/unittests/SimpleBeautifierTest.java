...
import com.google.code.alasc.SimpleBeautifier;

import junit.framework.TestCase;

/**
 * Test di unità della classe <tt>SimpleBeautifier</tt>.
 * 
...
public class SimpleBeautifierTest extends TestCase {
	...
	/**
	 * Inizializza l'istanza di <tt>SimpleBeautifier</tt> che verrà utilizzata
	 * dai test.
	 */
	...
	/**
	 * Verifica che il beautifier abbellisca correttamente un codice 
	 * ActionScript in cui è presente un blocco (in particolare, un
	 * blocco for).
	 */
