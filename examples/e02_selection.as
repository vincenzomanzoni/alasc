package 
{
	...
	public class e02_selection extends Sprite 
	{
		...
		public function e02_selection():void 
		{
			if (this.stage) {
				this.init(); 
			} else {
		...
		{
			var SHAPE_TYPE : Number = 3;
			if ( SHAPE_TYPE == 1 ) {
				setColor(255);
				for (var $7c672y : Number = 0; $7c672y < (360) ; $7c672y++) {
					goForward(1);
					rotateRight(1);
				}
			}
			if ( SHAPE_TYPE == 2 ) {
				setColor(16711680);
				for (var $tpmzcy : Number = 0; $tpmzcy < (4) ; $tpmzcy++) {
					goForward(100);
					rotateRight(90);
				}
			}
			if ( SHAPE_TYPE == 3 ) {
				setColor(65280);
				rotateRight(30);
				for (var $vgrexa : Number = 0; $vgrexa < (3) ; $vgrexa++) {
					rotateRight(120);
					goForward(100);
				}
			}
